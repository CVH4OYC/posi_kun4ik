...
import BackgroundLine from '../assets/bg/line.svg';
import HeroImage from '../assets/images/Фото 1 экран.png';
import Posik1 from '../assets/bg/Посикунчики 1 экран.png';

const Hero: React.FC = () => {
    return (
        <section id="top" className="relative w-full min-h-screen bg-white overflow-hidden flex items-center justify-center">
            {/* Змейка — фон */}
            <div
                className="fixed inset-0 z-0 pointer-events-none bg-no-repeat bg-top bg-cover"
                style={{
            ...
            <div className="relative z-10 max-w-screen-xl mx-auto px-6 py-24 flex items-center justify-between gap-10">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-lg text-gray-700 max-w-md leading-relaxed">
                        Концепция проекта основана на идее функциональных сувениров, которые становятся настоящими спутниками для людей, ищущих смысл, важные связи с природой и Пермским краем.
                    </p>
                </div>
