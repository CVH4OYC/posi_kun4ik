                ...
                <div className="flex-1 relative z-10">
                    ...
                    <ul className="flex flex-col gap-20 relative z-20">
                        ...
                        <li className="ml-auto w-11/12 md:w-5/6">
                            <span className="text-lg text-black font-semibold block mb-2">Функциональность и стиль:</span>
                            <p className="text-lg text-black leading-relaxed">
                        ...
                        <li>
                            <span className="text-lg text-black font-semibold block mb-2">Осознанность и экология:</span>
                            <p className="text-lg text-black leading-relaxed">
